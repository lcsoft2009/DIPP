    ...
    public static void  main (String [] agrs) {
        try {
          ...
          /*  HBaseDB.creatTable(tablename, familys);
            ...
            //add record  baoniu
            HBaseDB.addRecord(tablename,"baoniu","grade","","4");
            HBaseDB.addRecord(tablename,"baoniu","course","math","89");
             
            System.out.println("===========get one record========");
            HBaseDB.getOneRecord(tablename, "zkb");
