...
public class Im2Gray extends Configured implements Tool{
	...
	public static class MyMapper extends Mapper<ImageHeader, FloatImage, IntWritable, FloatImage>
	{
   ...
   //   	FloatImage gray = value.crop(0, 0, 100, 100);
	...
	public static class MyReducer extends Reducer<IntWritable, FloatImage, IntWritable, FloatImage> {
		...
		//	a neccessary step to avoid files with duplicate hash values
			...
			encoder.encodeImage(mean,encoder.createSimpleHeader(mean), os);
